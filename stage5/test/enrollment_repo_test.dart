...
void main() {
  ...
  Future<void> createProgram(
    ...
    for (final athleteId in ['athlete1', 'athlete2', 'athlete3']) {
      await fakeFirestore
  ...
  group('EnrollmentRepository', () {
    ...
    group('enrollAthlete', () {
      ...
      test('blocks self-enrollment into a personal program', () async {
      ...
      test('throws without an active trainer-client relationship', () async {
        await createProgram('prog1');
        await fakeFirestore
            .collection('trainerClientRelationships')
            .doc('coach1_athlete1')
