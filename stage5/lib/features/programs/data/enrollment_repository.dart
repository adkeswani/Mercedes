...
class EnrollmentRepository {
  ...
  /// Verifies the caller owns an assignable program and, when requested, has
  /// an active trainer-client relationship with the athlete.
  Future<void> _verifyCanManageRoster(
      String programId, String athleteId, String callerUserId,
      {required bool requireActiveRelationship}) async {
    final programDoc =
    ...
    if (requireActiveRelationship && athleteId != callerUserId) {
      ...
      if (!relationship.exists ||
        ...
        throw StateError(
          'Trainer $callerUserId has no active relationship with $athleteId',
        );
      }
    }
  }
